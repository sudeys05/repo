    ...
    const sampleVehicles = [
      {
        ...
        model: 'Explorer',
        year: 2023,
        currentLocation: JSON.stringify([-122.4194, 37.7749]), // San Francisco Downtown
      ...
      },
      {
        ...
        year: 2022,
        currentLocation: JSON.stringify([-122.3894, 37.7594]), // Mission District SF
        assignedArea: JSON.stringify([
          [-122.4200, 37.7700],
          [-122.3700, 37.7700],
          [-122.3700, 37.7500],
      ...
      },
      {
        ...
        model: 'Tahoe',
        year: 2023,
        currentLocation: JSON.stringify([-122.4094, 37.7849]), // Pacific Heights SF
        assignedArea: JSON.stringify([
          [-122.4300, 37.7900],
          [-122.3900, 37.7900],
          [-122.3900, 37.7700],
      ...
      },
      {
        ...
        model: 'F-550',
        year: 2021,
        currentLocation: JSON.stringify([-122.4394, 37.7949]), // Marina District SF
        assignedArea: JSON.stringify([
          [-122.4600, 37.8000],
          [-122.4100, 37.8000],
          [-122.4100, 37.7800],
      ...
      },
      {
        ...
        model: 'Charger',
        year: 2022,
        currentLocation: JSON.stringify([-74.0060, 40.7128]), // New York City
        assignedArea: JSON.stringify([
          [-74.0200, 40.7200],
          [-73.9900, 40.7200],
          [-73.9900, 40.7050],
      ...
      {
        vehicleId: 'PATROL-004', 
        licensePlate: 'POL-004',
        vehicleType: 'motorcycle',
        make: 'BMW',
        model: 'RT-P',
        year: 2023,
        currentLocation: JSON.stringify([-118.2437, 34.0522]), // Los Angeles
        assignedArea: JSON.stringify([
          [-118.2600, 34.0600],
          [-118.2300, 34.0600],
          [-118.2300, 34.0400],
      ...
      {
        vehicleId: 'K9-002',
        licensePlate: 'POL-K9-002',
        vehicleType: 'k9',
        make: 'Ford',
        model: 'Expedition',
        year: 2023,
        currentLocation: JSON.stringify([-87.6298, 41.8781]), // Chicago
        assignedArea: JSON.stringify([
          [-87.6500, 41.8900],
          [-87.6100, 41.8900],
          [-87.6100, 41.8650],
