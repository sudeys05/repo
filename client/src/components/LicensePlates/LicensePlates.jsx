            ...
            <div key={plate.id} className="plate-card" onClick={() => navigateToView('detail', plate)}>
              ...
              <div className="plate-body">
                <div className="owner-info">
                  ...
                  <p className="plate-id">Plate ID: #{plate.id}</p>
                  {plate.idNumber && (
                    <p className="id-number">National ID: {plate.idNumber}</p>
                  )}
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log('License plate added successfully:', result);
          // Add the new plate to the current list immediately
          if (result.licensePlate) {
            setPlates(prevPlates => [...prevPlates, result.licensePlate]);
          }
          await fetchPlates(); // Also refresh to ensure consistency
          goBack();
        } else {
        ...
        <div className="detail-grid">
          <div className="detail-section">
            ...
            <div className="info-grid">
              ...
              <div><strong>National ID:</strong> {selectedPlate?.idNumber || 'Not provided'}</div>
          ...
          <div className="detail-section">
            ...
            <div className="info-grid">
              <div><strong>Plate ID:</strong> #{selectedPlate?.id}</div>
